...
# @examples
#
# out = cached_post(url="https://species.biodiversitydata.se/ws/species/lookup/bulk",body=jsonlite::toJSON(list(names=c("Vulpes vulpes","Lutra"))),type="json")
