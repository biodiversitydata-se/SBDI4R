...
```
Else, you can search available data resources, collections (and more) using the interactive function `pick_filter`.
The `pick_filter` function lets you explore data collections, spatial layers, and soon more indexed fields.
```{r, message=FALSE, eval= FALSE}
