...
```{r, message=FALSE}
xf <- occurrences(taxon="Callitriche cophocarpa", 
                 fq=c("basis_of_record:HumanObservation","basis_of_record:HumanObservation"),
                 email="test@test.org", 
                 download_reason_id=10)
...
## Example 7: Agragating data with 'BIRDS'
BIRDS is a package that 
